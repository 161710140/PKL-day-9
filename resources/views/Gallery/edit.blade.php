			  	...
			  	<form action="{{ route('galleri.update',$galleri->id) }}" method="post" enctype="multipart/form-data" >
        			...
        			{{ csrf_field() }}
			  		<div class="form-group {{ $errors->has('nama') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="nama" class="form-control" value="{{ $galleri->nama }}"  required>
			  			@if ($errors->has('nama'))
                      ...
                      <div class="form-group {{ $errors->has('file_gambar') ? ' has-error' : '' }}">
			  			...
			  			<input type="file" name="file_gambar" class="form-control" value="{{ $galleri->file_gambar }}"  required>
